...
import { FileInput, Button, Label, Checkbox, Card, Select } from "flowbite-react";
    ...
    return (
        <Card>
            <div className="flex flex-col gap-4 justify-center">
                ...
                <Button onClick={handleUpload} disabled={uploading || !file} className="mt-4">{uploading ? "Uploading..." : "Upload"}</Button>
            </div>
        </Card>
    )
}
